...
public abstract class PgSqlIncludeListener implements ru.smartflex.tools.pg.PgSQLIncludeParserListener {
    ...
    public void exitFunctionBlockStatement(ru.smartflex.tools.pg.PgSQLIncludeParser.FunctionBlockStatementContext ctx) {
    ...
    public void enterPgTypeFull(ru.smartflex.tools.pg.PgSQLIncludeParser.PgTypeFullContext ctx) {

    }

    public void exitPgTypeFull(ru.smartflex.tools.pg.PgSQLIncludeParser.PgTypeFullContext ctx) {
